...
import { suggestGeoStrategy } from '@/ai/flows/suggest-geo-strategy';
...
const FormSchema = suggestGeoStrategy.inputSchema;
...
export function AdPlanForm({ onSubmit }: AdPlanFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        />
        <button type="submit" id="hidden-submit-button" className="hidden">
          Submit
        </button>
      </form>
    </Form>
